...
ALTER TABLE activities ADD COLUMN IF NOT EXISTS activity_type TEXT DEFAULT 'general';
ALTER TABLE activities ADD COLUMN IF NOT EXISTS our_story TEXT;
ALTER TABLE activities ADD COLUMN IF NOT EXISTS our_story_image TEXT;

-- Add index for activity_type
CREATE INDEX IF NOT EXISTS idx_activities_activity_type ON activities(activity_type);

-- Add comments for activity fields
COMMENT ON COLUMN activities.activity_type IS 'Type of activity: "general" for public activities, "lodge-experience" for lodge-specific experiences';
COMMENT ON COLUMN activities.our_story IS 'Story/narrative about the activity or experience';
COMMENT ON COLUMN activities.our_story_image IS 'Image for the activity story section';
...
AND column_name IN ('activity_type', 'our_story', 'our_story_image')
ORDER BY column_name;
